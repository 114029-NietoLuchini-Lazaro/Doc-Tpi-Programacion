...
public class RagChatResponse {
    ...
    // Observabilidad de la recuperación (diagnóstico del RAG)
    private String rutaRetrieval;          // "PGVECTOR" | "MEMORIA"
    private int nroChunks;                 // Chunks recuperados como contexto
    private int paginasCubiertas;          // Páginas distintas representadas en el contexto
    private boolean embeddingsDisponibles; // true si el servicio de embeddings estaba configurado
}
