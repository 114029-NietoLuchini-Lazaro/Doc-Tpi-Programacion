...
export interface RagDocumentInfo {
  ...
  uploadedAt: string;
  previewText: string;
  pageCountConTexto?: number;
  indexedWithVectors?: boolean;
}
...
export interface RagChatResponse {
  respuesta: string;
  estado: string; // "OK", "BLOCKED_PROFANITY", "BLOCKED_INJECTION", "BLOCKED_VALIDATION", "BLOCKED_NO_SOURCE", "BLOCKED_NO_CONTEXT", etc.
