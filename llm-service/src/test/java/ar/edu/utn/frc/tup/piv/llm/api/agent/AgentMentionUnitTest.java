...
import ar.edu.utn.frc.tup.piv.llm.application.agent.QuotaExceededException;
...
class AgentMentionUnitTest {
  ...
  void testControllerOverloadsAndFallbacks() {
    ...
    var h02Req = new ar.edu.utn.frc.tup.piv.llm.api.agent.dto.AgentMentionRequest(
    ...
    ResponseEntity<?> response5 = controller.handleMention((ar.edu.utn.frc.tup.piv.llm.api.agent.dto.AgentMentionRequest) null);
    assertThat(response5.getStatusCode()).isEqualTo(HttpStatus.NO_CONTENT);

    var h02BotReq = new ar.edu.utn.frc.tup.piv.llm.api.agent.dto.AgentMentionRequest(
    ...
    var h02LoopReq = new ar.edu.utn.frc.tup.piv.llm.api.agent.dto.AgentMentionRequest(
