package ar.edu.utn.frc.tup.piv.llm.api.agent.validation;

import ar.edu.utn.frc.tup.piv.llm.api.agent.AgentMentionRequest;
...
public class MentionSenderValidator {
    ...
    public Optional<ResponseEntity<Void>> validate(ar.edu.utn.frc.tup.piv.llm.api.agent.dto.AgentMentionRequest request) {
        if (request == null) {
            return Optional.of(silentDropResponse());
        }
        return validate(request.senderRole());
