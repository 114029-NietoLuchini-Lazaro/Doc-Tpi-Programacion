...
public class AgentMentionController {
   ...
   */
  public ResponseEntity<?> handleMention(ar.edu.utn.frc.tup.piv.llm.api.agent.dto.AgentMentionRequest req) {
    if (req == null) {
      return ResponseEntity.noContent().build();
    }
    ...
    if (service == null) {
      ...
      return ResponseEntity.ok(new ar.edu.utn.frc.tup.piv.llm.api.agent.dto.AgentMentionResponse(
