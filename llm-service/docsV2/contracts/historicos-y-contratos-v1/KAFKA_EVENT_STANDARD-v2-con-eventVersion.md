> ⚠️ **REEMPLAZADO el 2026-09-20 — solo histórico.** Este es el estándar anterior (envelope con `eventVersion`,
> `eventType` con guiones, un tópico por dominio propuesto por nosotros). Lo reemplaza el estándar del PDF
> `KAFKA.pdf`, transcrito en [`../KAFKA_EVENT_STANDARD.md`](../KAFKA_EVENT_STANDARD.md) (ADR-020). No usar para
> integrar.
