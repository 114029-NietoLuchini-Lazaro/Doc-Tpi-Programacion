...
didáctica ([14 §C-2 / A-1](../../08-preguntas-investigacion-y-sincronizaciones/02-sincronizacion-con-guia-didactica.md)), que revisa a
[ADR-009](../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md).

**Debe fusionarse en `llm-service-v1.openapi.yaml` cuando se cierre [I-10](../90-mapa-de-integracion-historico.md)
