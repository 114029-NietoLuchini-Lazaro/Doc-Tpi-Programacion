...
> conserva decisiones y secuencias históricas; sus ejemplos `/ai/**` no son rutas vigentes.
...
> [`tema-05-desafios-practicos.md`](tema-05-desafios-practicos.md).
...
[`llm-service-v1.asyncapi.yaml`](../historicos-y-contratos-v1/llm-service-v1.asyncapi.yaml)) hoy solo declara
...
3. Si se agota el margen, publicamos `score_pendiente_diferido` (payload en la sección
   ...
   null`** (ver [`backend-de-negocio/contratos.md`](backend-de-negocio.md)).
