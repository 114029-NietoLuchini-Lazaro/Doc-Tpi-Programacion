...
>
> **Reemplaza** al estándar anterior con `eventVersion` y `eventType` con guiones, que se conserva como
> histórico en [`historicos-y-contratos-v1/KAFKA_EVENT_STANDARD-v2-con-eventVersion.md`](historicos-y-contratos-v1/KAFKA_EVENT_STANDARD-v2-con-eventVersion.md).
> Decisión registrada en [`../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md`](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md).
