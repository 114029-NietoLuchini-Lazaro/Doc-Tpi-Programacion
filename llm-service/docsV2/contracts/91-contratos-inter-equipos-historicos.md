...
contrato vigente es [`contracts/llm-service-v1.openapi.yaml`](historicos-y-contratos-v1/llm-service-v1.openapi.yaml)
para HTTP y [`contracts/llm-service-v1.asyncapi.yaml`](historicos-y-contratos-v1/llm-service-v1.asyncapi.yaml) para
...
> [`equipos/tema-05-desafios-practicos.md`](equipos/tema-05-desafios-practicos.md)
...
> **El detalle completo de cada equipo se centralizó en** `docsV2/contracts/equipos/`
> (un archivo `.md` por contrato canónico y `pendientes.md` en la carpeta de trabajo para lo que falta), con JSON y diagramas
> incluidos. Esta sección queda como índice para no tener que adivinar en qué carpeta buscar.

| Equipo | Carpeta |
|---|---|
| Tema 02 — Cursos y Matrícula | [`equipos/tema-02-cursos-y-matricula.md`](equipos/tema-02-cursos-y-matricula.md)
| Tema 03 — Motor de Desafíos (integración indirecta desde el 2026-09-13, ver [§4.2 antiguo](equipos/tema-03-motor-de-desafios.md)) | [`equipos/tema-03-motor-de-desafios.md`](equipos/tema-03-motor-de-desafios.md)
| Tema 05 — Desafíos Prácticos | [`equipos/tema-05-desafios-practicos.md`](equipos/tema-05-desafios-practicos.md)
| Tema 11 — Chat | [`equipos/tema-11-chat.md`](equipos/tema-11-chat.md)
| Tema 12 — Backoffice / ADMIN | [`equipos/tema-12-backoffice-admin.md`](equipos/tema-12-backoffice-admin.md)
| Backend de negocio | [`equipos/backend-de-negocio.md`](equipos/backend-de-negocio.md)
| Front End — Angular | [`equipos/frontend-angular.md`](equipos/frontend-angular.md)
| Product Owner | [`equipos/product-owner.md`](equipos/product-owner.md)
...
| Si querés | Andá a |
|---|---|
| Diagramas de secuencia de cada función | [17 — Mapa de integración](90-mapa-de-integracion-historico.md)
| El contrato completo campo por campo | [02 — Arquitectura y stack](../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) Parte 3 |
| Todos los pendientes I-01 a I-16 | [17 — §8](90-mapa-de-integracion-historico.md)
| Las decisiones abiertas con fecha y dueño | [08 — Decisiones y pendientes](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)
| El glosario para la sesión de integración | [11 — Glosario y metadata](../00-gobierno-y-evolucion/03-glosario-y-metadata.md)
| Reglas de red y gateway | [gateway-y-discovery/](../02-arquitectura-y-plataforma/06-gateway-y-discovery)
