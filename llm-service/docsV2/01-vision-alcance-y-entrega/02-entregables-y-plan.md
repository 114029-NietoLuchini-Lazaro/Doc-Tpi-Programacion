...
> antecedente. [23 · Construcción del producto LLM](../07-planificacion-y-trabajo-equipo/03-plan-de-construccion-del-producto.md) llegó a
> plantear 12 integrantes, tres fases y 19 sprints quincenales — horizonte **retirado**. El plan
> de calendario vigente es **[38 — Plan de 5 sprints](../07-planificacion-y-trabajo-equipo/05-plan-de-cinco-sprints.md)**. Las funciones
...
> Su equivalente vigente es: reparto en **5 parejas P1–P5** en [23 · §3](../07-planificacion-y-trabajo-equipo/03-plan-de-construccion-del-producto.md)
> (esto sí sigue vigente), y la secuencia de construcción en
> [38 — Plan de 5 sprints](../07-planificacion-y-trabajo-equipo/05-plan-de-cinco-sprints.md)

> **Punto de partida actualizado.** Antes de estimar o repartir pasos, usar la matriz [21](../00-gobierno-y-evolucion/04-matriz-trazabilidad.md) y los contratos canónicos V2. Esta planificación previa mantiene información de contexto, pero no habilita trabajo de Fase 2/Fase 3 ni endpoints `/ai/*`.
...
> la lista de ADR** de [08](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md), Parte A — no este documento.
...
| **Base propia** | PostgreSQL 16, exclusiva nuestra; `pgvector` queda pendiente de la fase RAG y no es dependencia del MVP ejecutable | ✅ |
...
| **Agente `@mención`** | 🔵 Fase 3 | RF-CHT-05. Diseñado en [04](../03-capacidades-de-ia/02-funciones-de-ia.md) Parte 4, fuera de este cuatrimestre |
...
Cambios respecto de [08](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) con la información nueva:
...
> [03](../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) §8. Resumen: solo los pasos 1, 5, 10 y 12 llaman a un modelo,
...
[04](../03-capacidades-de-ia/02-funciones-de-ia.md) §1b.
...
[02](../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md), Parte 3, endpoint 5: implementarla distinta acá es publicar dos
...
> [04](../03-capacidades-de-ia/02-funciones-de-ia.md) Parte 4 y ahí se queda hasta que alguien lo priorice.
