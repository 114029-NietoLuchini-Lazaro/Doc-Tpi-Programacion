...
> ítems que [17 — Mapa de integración §8](../../contracts/90-mapa-de-integracion-historico.md#8-lo-que-estos-diagramas-dejaron-a-la-vista)
> (tabla I-01 a I-16) y [18 — Contratos inter-equipos §6](../../contracts/91-contratos-inter-equipos-historicos.md#6-agenda-mínima-para-la-sesión-de-integración)
...
> [18 — Contratos inter-equipos](../../contracts/91-contratos-inter-equipos-historicos.md) y, si tocan el schema, a
> los YAML de [`docs/contracts/`](../../contracts/historicos-y-contratos-v1) — ver checklist en la sección 5.
>
...
- [ ] Si I-04/I-05 cambian un payload: actualizar
      [`llm-service-v1.asyncapi.yaml`](../../contracts/historicos-y-contratos-v1/llm-service-v1.asyncapi.yaml) y avisar a
...
- [ ] Si I-14 fija el formato del token: agregar `security` al
      [`llm-service-v1.openapi.yaml`](../../contracts/historicos-y-contratos-v1/llm-service-v1.openapi.yaml).
- [ ] Si I-08 cierra el esquema de `mensaje`: avisar a P5 y actualizar
      [`llm-service-v1-moderacion-borrador.yaml`](../../contracts/historicos-y-contratos-v1/llm-service-v1-moderacion-borrador.yaml)
      si corresponde (sigue siendo borrador, EP-08 no arrancó).
- [ ] Actualizar la fecha y el estado de I-04/I-05/I-08/I-09/I-14 en
      [17 — Mapa de integración §8](../../contracts/90-mapa-de-integracion-historico.md).
