...
> - los criterios de aceptación y escenarios BDD de [`docs/historias/ep-03/`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/historias/ep-03/README.md);
> - la ficha de épica [`docs/epicas/ep-03.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/epicas/ep-03.md);
> - la **DoD por historia** y **por incremento** de [23 · §9.2](../../07-planificacion-y-trabajo-equipo/03-plan-de-construccion-del-producto.md);
> - la [adenda S1 del contrato](../../contracts/historicos-y-contratos-v1/llm-service-v1-s1-golden-set-adenda.md).
>
...
| 7 | Página de Wiki `G03 - GOLDEN SET` al día (formato [27](../../07-planificacion-y-trabajo-equipo/07-guia-wiki-taiga.md), HU por permalink, diagramas de la secuencia) | ❌ no verificable en el repo (vive en Taiga); pendiente |
