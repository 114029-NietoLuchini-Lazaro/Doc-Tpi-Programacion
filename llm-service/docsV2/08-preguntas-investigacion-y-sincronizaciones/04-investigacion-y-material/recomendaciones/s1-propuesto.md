...
> [plantilla de sprint LLM](../../../07-planificacion-y-trabajo-equipo/10-plantillas/sprint-llm.md); los valores de referencia **no
...
> ([sprints/sprint-0.md · §4](../../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-0/sprint-0.md)).
>
> **Fuentes:** receta de S1 en [`35`](../../../07-planificacion-y-trabajo-equipo/04-backlog-ejecutable.md) ·
> historias en [`historias/`](../../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/historias/README.md) (índice del sprint en [`sprints/s1-historias.md`](../../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-historias.md)) · épicas [`ep-01.md`](../../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/epicas/ep-01.md) /
> [`ep-03.md`](../../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/epicas/ep-03.md) · DoR/DoD [23 · §9.2](../../../07-planificacion-y-trabajo-equipo/03-plan-de-construccion-del-producto.md).
...
([`../sprints/README.md`](../../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/README.md)) — corre en Pista B (P2+P3), en paralelo con
...
| `LLM-S01-H09` | *(equipo)* suite de pruebas y guía de demo de S1 | [24](../../../06-operacion-calidad-y-pruebas/02-convenciones-de-cobertura.md); [25](../../../06-operacion-calidad-y-pruebas/03-matriz-de-pruebas-de-infraestructura.md) | Unitarias + Testcontainers/Flyway + WireMock del Gateway + prueba de reinicio de Compose; cobertura ≥ 95 %; guía de demo reproducible. **Neg:** cobertura bajo umbral → CI falla; pérdida de datos en reinicio → falla y bloquea la Review | **P1** (una persona por pareja) | H04–H07 | 18 | *(Planning)* | Pendiente |
