...
[`docs/31`](../../../03-capacidades-de-ia/golden-set-y-calibracion/01-plan-de-revision.md) y la especificación funcional en
[`docs/32`](../../../03-capacidades-de-ia/golden-set-y-calibracion/02-especificacion-funcional.md).
...
> [`docs/08`](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md).
...
| Las 5 dimensiones y sus pesos, 30/25/20/15/10 | [13](../../../03-capacidades-de-ia/03-rubricas-y-prompts.md) §1 |
| Tolerancia PAR-14: MAE ≤ ±5,0 promedio · ≤ ±10,0 por dimensión | [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) §3 |
| Muestreo docente PAR-10 del 10 % | [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §3 |
| Golden set en dos niveles: 50 base · 15-20 por curso | [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §4c |
| Quién puntúa el golden set: docentes, nunca un modelo | [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §4b |
| Los cinco roles de IA (RF-IA-23) | [01](../../../01-vision-alcance-y-entrega/01-problema-y-alcance.md) |
| Evaluador sin plan B (RF-IA-25) frente a pools para el resto | [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §5 |
| Los cinco costos unitarios por función | [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) §2 |
...
número significaba otra decisión que en [`docs/08`](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md).
...
- El buffer anti-fuga dice **JavaParser**, no `tree-sitter`. Es el argumento de
  [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md): con los desafíos en Java, JavaParser es
...
[`docs/17`](../../../contracts/90-mapa-de-integracion-historico.md) fija el contrato bajo `/ai/…`.
...
[`docs/03`](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) decía **USD 5 a 22 por
...
[`docs/03`](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) §1, y el **ADR-010** de
[`docs/08`](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) suma la cláusula de revisión: si el
