...
Este documento transforma las fases en reglas de ejecución. Se lee antes de tomar una tarea de `35-backlog-ejecutable.md`. No reemplaza los contratos ni autoriza a inventar campos, rutas o eventos.
...
Orden de precedencia: PRD e `idea.pptx.pdf`; `00-fuentes-de-verdad-y-convenciones.md`; contratos v1; decisiones aprobadas; este plan. Los documentos de `importado/` son antecedentes y pueden contradecir las fuentes vigentes.
...
**Fuente única: [23 · §9.2](03-plan-de-construccion-del-producto.md).** Este playbook no
...
- Cobertura de código según [24 · convención de cobertura](../06-operacion-calidad-y-pruebas/02-convenciones-de-cobertura.md)
