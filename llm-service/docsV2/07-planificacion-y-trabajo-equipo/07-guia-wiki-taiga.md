...
>
> Complementos: [28 · Normativa de la cátedra](../00-gobierno-y-evolucion/06-normativa-de-catedra.md)
> [`plantillas/pagina-wiki-grupo.md`](10-plantillas/pagina-wiki-grupo.md)
...
([`plantillas/historia-de-usuario-taiga.md`](10-plantillas/historia-de-usuario-taiga.md)
...
|---|---|
| DER / esquema de datos | [11 Parte B](../00-gobierno-y-evolucion/03-glosario-y-metadata.md))
| BPMN / flujo de negocio | [04 · Funciones de IA](../03-capacidades-de-ia/02-funciones-de-ia.md), [17 · Mapa de integración](../contracts/90-mapa-de-integracion-historico.md)
| Clases / patrones | [11 "Patrones de diseño"](../00-gobierno-y-evolucion/03-glosario-y-metadata.md))
| Estados | ciclo de vida de `evaluacion` / `curso-cohorte` en [04](../03-capacidades-de-ia/02-funciones-de-ia.md))
| Secuencias | Mermaid de [17 · Mapa de integración](../contracts/90-mapa-de-integracion-historico.md), [18 · Contratos inter-equipos](../contracts/91-contratos-inter-equipos-historicos.md)
| Microservicios | [02 · Arquitectura y stack](../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md)covery/README.md)
...
> están en [28 §6](../00-gobierno-y-evolucion/06-normativa-de-catedra.md)
...
- Template de Historia de Usuario (HU) → [`plantillas/historia-de-usuario-taiga.md`](10-plantillas/historia-de-usuario-taiga.md). Cómo se completa cada apartado: [29 · Guía de cátedra: Historias de Usuario](08-guia-de-historias-de-usuario.md)
- Template de Épicas → [`plantillas/epica-taiga.md`](10-plantillas/epica-taiga.md)
- Template de Tarea → [`plantillas/tarea-taiga.md`](10-plantillas/tarea-taiga.md). Método SMART para el desglose: [29 · §4](08-guia-de-historias-de-usuario.md)y [23 · §9.2](03-plan-de-construccion-del-producto.md)
- Template de Proyecto por Grupo → [`plantillas/pagina-wiki-grupo.md`](10-plantillas/pagina-wiki-grupo.md)
...
| Trazabilidad requerimiento ↔ implementación a nivel de HU. | [21 · Matriz de trazabilidad LLM](../00-gobierno-y-evolucion/04-matriz-trazabilidad.md) a nivel de requisito y contrato. |
