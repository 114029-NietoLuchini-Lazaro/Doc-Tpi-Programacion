...
- **Maqueta / documentación:** el "chequeo de salud" y el
  [documento base del contrato](../../../../contracts/historicos-y-contratos-v1/llm-service-v1.openapi.yaml).
...
- **Maqueta / documentación:** el [agregado de este tramo al contrato](../../../../contracts/historicos-y-contratos-v1/llm-service-v1-s1-golden-set-adenda.md).
...
- **Capturas:** no aplica.
- **Maqueta / documentación:** el [contrato base](../../../../contracts/historicos-y-contratos-v1/llm-service-v1.openapi.yaml)
