...
> [`plantillas/sprint-llm.md`](../../../10-plantillas/sprint-llm.md)) para el ciclo que cierra los huecos
> de S1 y construye lo que falta de la Entrega 1. No es un sprint numerado de la receta original
> ([`35`](../../../04-backlog-ejecutable.md)) — nace de dos documentos ya escritos:
>
> | Fuente | Qué aporta |
> |---|---|
> | [`entregas/checklist-cierre-s1.md`](../../../../01-vision-alcance-y-entrega/03-entregas/checklist-cierre-s1.md) | Los 6 bloqueantes/huecos de S1 tal cual se definió originalmente |
> | [`entregas/entrega-1.md`](../../../../01-vision-alcance-y-entrega/03-entregas/entrega-1.md) | Los 3 ítems que faltan para la Entrega 1 real (más ambiciosa que S1 original) |
> | [`entregas/backlog-priorizado-cierre-s1.md`](../../../../01-vision-alcance-y-entrega/03-entregas/backlog-priorizado-cierre-s1.md) | El orden — dos vistas: valor de demo (PO) y dependencia técnica (equipo) |
>
> **Qué NO es.** No reabre `605f381` ni el flujo v2 de golden set — eso ya está resuelto
> ([decision-605f381.md](../../../../01-vision-alcance-y-entrega/03-entregas/decision-605f381.md)). Tampoco reemplaza las 240 h de S1
> original en [`35`](../../../04-backlog-ejecutable.md): las suma, porque son huecos sobre ese mismo
> compromiso, no un sprint nuevo. El horizonte de calendario vigente es de **5 sprints máximo**
> — ver [38](../../../05-plan-de-cinco-sprints.md); este cierre es parte del Sprint 1 de ese plan, no una
> numeración aparte.
>
...
|---|---|
| Sprint / fase | Cierre S1 / F1 (parte del Sprint 1 de [38](../../../05-plan-de-cinco-sprints.md)) |
| Inicio y cierre del ciclo | *(a completar en Planning — 2 semanas)* |
| Fecha de Planning previa a ejecución | *(a completar)* |
| Objetivo y usuario beneficiado | Un docente autorizado publica rúbrica y golden set de su curso, encola una calibración contra el adaptador simulado (H10) y la calibración cierra con `PASSED`/`FAILED` y su métrica visible — sin haber gastado un centavo en un proveedor real ([entrega-1.md](../../../../01-vision-alcance-y-entrega/03-entregas/entrega-1.md)) |
...
Usar la tabla estándar de [`plantillas/sprint-llm.md` §3](../../../10-plantillas/sprint-llm.md) sin
...
> [`backlog-priorizado-cierre-s1.md`](../../../../01-vision-alcance-y-entrega/03-entregas/backlog-priorizado-cierre-s1.md) — no el de
...
| 7 | **Conectar calibración con el puerto de H10** | [`ep-04/h01.md`](../../tareas/ep-04/h01.md) T7 | P4 | H10 (✅). Ya no depende de la fila 8 (resuelto: usa `function_model_config`) | 14 | Entrega 1 | ✅ Hecho 2026-09-13 |
...
| 9 | Mock levantable + check CI de contrato no acordado | [`ep-01/h05.md`](../../tareas/ep-01/h05.md) T3, T4 | P1 | — | 4 | Cierre S1 | Pendiente |
| 10 | Reescribir T1 de h08 contra el contrato v2 (no v1) | [`ep-01/h05.md`](../../tareas/ep-01/h05.md) T1 (rework) | P1 | — (decidido: `v1` histórico, [checklist §2.5](../../../../01-vision-alcance-y-entrega/03-entregas/checklist-cierre-s1.md)) | 2 | Cierre S1 | Pendiente — ya desbloqueada |
| 11 | Prueba automatizada de reinicio de Compose | [`ep-01/h06.md`](../../tareas/ep-01/h06.md) T4 | Todas (1 persona) | 1 (Eureka no es prerequisito real de esto) | 3 | Cierre S1 | Pendiente |
| 12 | Guía de demo + activar gate de cobertura JaCoCo | [`ep-01/h06.md`](../../tareas/ep-01/h06.md) T6 | Todas (1 persona) | 1–11 (necesita todo lo demás terminado para poder escribirla) | 2 | Cierre S1 | Pendiente |
...
**Ampliación decidida el 2026-09-12** ([`backlog-priorizado-cierre-s1.md`](../../../../01-vision-alcance-y-entrega/03-entregas/backlog-priorizado-cierre-s1.md)):
...
costo de postergarlas: formalizar T3/T5 de [`ep-01/h06.md`](../../tareas/ep-01/h06.md) (contrato
WireMock + evidencia BDD) y unificar "cohorte"/"curso" en el resto de la documentación
([checklist §3.2](../../../../01-vision-alcance-y-entrega/03-entregas/checklist-cierre-s1.md)).
...
|---|---|---|---|---|---|
| D01 — Eureka/Gateway disponible | P1 / equipo de plataforma compartida | Fila 1 | Antes de la demo real (no antes de arrancar) | [08 · decisiones · A-4](../../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) | **Ya no bloquea el arranque (2026-09-12):** la fila 1 se desarrolla y prueba contra el Eureka local de `compose.yaml` mientras se espera confirmación — mismo criterio que A-4. Sigue pendiente **solo** para la validación final de que el Gateway compartido rutea de verdad |
| ~~Respuesta técnica: ¿`function_model_config` o `model_deployment`?~~ | — | ~~Filas 7 y 8~~ | — | [`h01.md`](../../tareas/ep-04/h01.md) T7, nota | ✅ Resuelta el 2026-09-12 leyendo el código: `function_model_config`. Las filas 7 y 8 quedaron independientes entre sí |
| ~~Decisión sobre `llm-service-v1.openapi.yaml`~~ | ~~Equipo completo~~ | ~~Fila 10~~ | — | [`checklist-cierre-s1.md` §2.5](../../../../01-vision-alcance-y-entrega/03-entregas/checklist-cierre-s1.md) | ✅ Resuelta el 2026-09-12: histórico. Fila 10 ya puede arrancar |
...
- [ ] El trabajo cabe en la capacidad individual y total (con la ampliación: **P1 ≈66 h**, **P4
      ...
      [`backlog-priorizado-cierre-s1.md` · veredicto de capacidad](../../../../01-vision-alcance-y-entrega/03-entregas/backlog-priorizado-cierre-s1.md)).
