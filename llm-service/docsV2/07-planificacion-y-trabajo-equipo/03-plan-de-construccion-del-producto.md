...
> [38 — Plan vigente: máximo 5 sprints](05-plan-de-cinco-sprints.md); los "19 sprints" de este
...
> semanas** — **cifra histórica, superada por [38](05-plan-de-cinco-sprints.md)**. Cada sprint
...
de [10](../01-vision-alcance-y-entrega/02-entregables-y-plan.md)omo
antecedentes. No reemplaza el PRD, las [convenciones](../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md)
ni los contratos inter-equipos. La cobertura funcional se consulta en
[21](../00-gobierno-y-evolucion/04-matriz-trazabilidad.md)

El calendario de este documento se ejecuta mediante el [playbook para agentes](06-playbook-de-construccion.md)
y el [backlog ejecutable de S1–S19](04-backlog-ejecutable.md)
...
[backlog ejecutable](04-backlog-ejecutable.md) estiman el trabajo
...
S1–S10) que este documento llegó a plantear — **retirado, ver [38](05-plan-de-cinco-sprints.md)
...
[29 · §5–6](08-guia-de-historias-de-usuario.md). El plan de sprints manda en horas; Taiga
...
La cola interna en PostgreSQL sigue la revisión de [06](../06-operacion-calidad-y-pruebas/01-operacion-e-ingenieria.md), Parte 6.
...
Partir de [OpenAPI v1](../contracts/historicos-y-contratos-v1/llm-service-v1.openapi.yaml)
[AsyncAPI v1](../contracts/historicos-y-contratos-v1/llm-service-v1.asyncapi.yaml). Sus respuestas y payloads incompletos se
...
El [playbook de construcción](06-playbook-de-construccion.md) aplica estas
...
1. **Usuario y resultado observable**: se sabe quién la usa y qué puede hacer al terminar. El
   **COMO** nombra un rol real (docente, alumno, ADMIN, operador), no «el sistema» ni «el equipo»
   ...
   ([29 · §4](08-guia-de-historias-de-usuario.md)
2. **Criterios de aceptación comprobables en formato BDD** (Dado / Cuando / Entonces), con al
   ...
   ([29 · §2.5](08-guia-de-historias-de-usuario.md)
...
8. **Estimación** hecha en equipo, al final del refinamiento y **después** de tener los criterios
   de aceptación ([29 · §5](08-guia-de-historias-de-usuario.md)). En Taiga se registra en
...
9. **Historia sana según INVEST** —Independiente, Negociable, Valiosa, Estimable, Small,
   Testeable ([29 · §3](08-guia-de-historias-de-usuario.md))—. Si falla la **V** casi
...
[template oficial de Taiga](10-plantillas/historia-de-usuario-taiga.md) (Como/Quiero/Para, Notas,
CA con negativos, BDD ≥ 3 escenarios, Prototipo, Estimación Fibonacci + MoSCoW, Dependencias); el
método para completar cada apartado es [29](08-guia-de-historias-de-usuario.md). El ID
...
[backlog ejecutable](04-backlog-ejecutable.md)
...
6. Pruebas: unitarias de reglas; integración de persistencia/migración; contrato con WireMock o
   ...
   [24](../06-operacion-calidad-y-pruebas/02-convenciones-de-cobertura.md)
...
7. Documentación y estado del backlog reflejan lo efectivamente entregado. La página del
   ...
   [27](07-guia-wiki-taiga.md): HU enlazadas por su permalink del backlog y diagramas de
...
Usar [la plantilla de sprint](10-plantillas/sprint-llm.md) para registrar el compromiso y el cierre.
La rutina diaria y el flujo Git están en [GITFLOW](../09-flujo-de-trabajo-del-equipo/01-gitflow.md)
[WORKFLOW_DIARIO](../09-flujo-de-trabajo-del-equipo/02-workflow-diario.md)
...
[backlog ejecutable](04-backlog-ejecutable.md). No se repite acá
