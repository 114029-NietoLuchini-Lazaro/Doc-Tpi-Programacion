...
> **Convención obligatoria.** La identidad externa del servicio es `llm-service` y todo controller atiende bajo `/api/llm/**`. Este documento conserva diagramas previos con `ms-evaluacion-llm`; para diseño nuevo mandan [00](../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md) y los contratos v1.
...
> queue* nativa, y la cola de [06](../06-operacion-calidad-y-pruebas/01-operacion-e-ingenieria.md) necesita las dos. Son canales
...
La [U1 de Front End](02-sincronizacion-arquitectura-y-despliegue.md) enseña **Nginx como gateway** de
...
[15](02-sincronizacion-arquitectura-y-despliegue.md)
...
> el proveedor es de 1 s ([14](../08-preguntas-investigacion-y-sincronizaciones/02-sincronizacion-con-guia-didactica.md) A-3), y al vencerse aplica la
...
lenguaje— está en [02](01-arquitectura-y-stack.md)
...
**El lenguaje cambia las herramientas, no el diseño.** Todo lo de [02](01-arquitectura-y-stack.md) vale igual.
