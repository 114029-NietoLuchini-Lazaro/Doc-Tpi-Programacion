...
6. [Laboratorio de integración local](07-laboratorio-integracion-local.md): Workbench, Gateway
   mock y Courses mock; el backend y la base permanecen reales.
7. [Gateway y discovery](06-gateway-y-discovery/README.md): red, Eureka, ruteo, identidad,
   comunicación micro a micro, resiliencia y pruebas obligatorias.
8. [Fronteras V2](../02-arquitectura-y-fronteras.md): referencia breve del límite entre Tema 07 y
