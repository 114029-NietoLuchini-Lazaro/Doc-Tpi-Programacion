...
> **Contrato de plataforma.** La rúbrica, sus pesos y prompts se mantienen independientes de rutas y proveedores; las invocaciones vigentes se describen en los contratos v1 bajo `/api/llm/**`.
...
> [08](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md), Parte C (ítems E-01 a E-06). Cada ajuste de las anclas es una `rubric_version` nueva.
...
| El pendiente E-05 | Cerrado en [08](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)
| `temperature: 0` + `seed` (A-3 de [14](../08-preguntas-investigacion-y-sincronizaciones/02-sincronizacion-con-guia-didactica.md)) | Un clasificador ya es determinístico |
