...
- [x] **GS-0113** Documentar ciclo de vida, versionado, publicación e inmutabilidad. Ver [32](02-especificacion-funcional.md)
- [x] **GS-0114** Documentar PAR-14 con ejemplos de aprobación y rechazo, incluyendo el máximo individual. Ver [32](02-especificacion-funcional.md#10-cálculo-de-par-14)
- [x] **GS-0115** Documentar selección y cambio de calibración activa con migración confirmada de desafíos sin intentos. Ver [32](02-especificacion-funcional.md#11-activación-y-asociación-con-desafíos)
- [x] **GS-0116** Documentar suspensión, cola y reanudación ante recalibración fallida. Ver [32](02-especificacion-funcional.md#12-recalibración-suspensión-y-cola)
- [x] **GS-0117** Documentar anonimización irreversible y procedencia de casos. Ver [32](02-especificacion-funcional.md#7-interacciones-reales-y-anonimización)
...
- [x] **GS-0201** Definir `RubricFamily`, `RubricVersion` y `RubricDimension`. Ver [33](03-modelo-de-dominio-y-transiciones.md)
- [x] **GS-0202** Definir `GoldenSetFamily`, `GoldenSetVersion` y `GoldenSetCase`. Ver [33](03-modelo-de-dominio-y-transiciones.md)
- [x] **GS-0203** Definir `ImportBatch` e `ImportRow` para staging. Ver [33](03-modelo-de-dominio-y-transiciones.md)
- [x] **GS-0204** Definir `CalibrationRun`, `CalibrationCaseResult` y `ActiveCalibration`. Ver [33](03-modelo-de-dominio-y-transiciones.md)
- [x] **GS-0205** Definir `ChallengeCalibrationAssignment` y su bloqueo por primer intento. Ver [33](03-modelo-de-dominio-y-transiciones.md)
- [x] **GS-0206** Definir `PendingEvaluation` para la cola de evaluaciones suspendidas. Ver [33](03-modelo-de-dominio-y-transiciones.md)
- [x] **GS-0207** Definir `ModelAdapter` y `ModelDeployment` administrados por ADMIN. Ver [33](03-modelo-de-dominio-y-transiciones.md)
...
- [x] **GS-0228** Versionar OpenAPI antes de implementar controladores. Borrador v2: [contrato](../../contracts/historicos-y-contratos-v1/llm-service-v2-golden-set.openapi.yaml)
