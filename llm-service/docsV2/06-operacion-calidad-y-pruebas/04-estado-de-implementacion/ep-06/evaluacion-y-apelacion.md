...
Objetivo de [`epicas/ep-06.md`](../../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/epicas/ep-06.md): *"Que cerrar un intento produzca un
...
[`35-backlog-ejecutable.md`](../../../07-planificacion-y-trabajo-equipo/04-backlog-ejecutable.md) reserva **S6 (~208 h)** y **S7
...
- [`sprints/README.md` · "Reprogramación a 8 semanas"](../../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/README.md) define el
...
- [`00-fuentes-de-verdad-y-convenciones.md` · §5](../../../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md),
...
[`08-decisiones-y-pendientes.md` · C-6](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) — con la tabla de
