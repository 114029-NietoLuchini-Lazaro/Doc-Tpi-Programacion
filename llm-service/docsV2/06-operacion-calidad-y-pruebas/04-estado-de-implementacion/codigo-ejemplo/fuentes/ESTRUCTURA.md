...
> mandan [`docs/00`](../../../../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md) y
> [`contracts/`](../../../../contracts/): el destino es `llm-service`, con base path
...
>
> Referencia de arquitectura: [02-arquitectura-y-stack.md](../../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md)
> Referencia de integración: [17-mapa-de-integracion.md](../../../../contracts/90-mapa-de-integracion-historico.md)
> Reparto por persona y plan de la demo: [10-entregables-y-plan.md](../../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md) Parte 2
...
> [10](../../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md) Parte 2 y quedaron superadas.** El reparto vigente es
> de **5 parejas P1–P5** ([23 · §3](../../../../07-planificacion-y-trabajo-equipo/03-plan-de-construccion-del-producto.md)) y **no
...
> carpeta?" manda la tabla de [23 · §3](../../../../07-planificacion-y-trabajo-equipo/03-plan-de-construccion-del-producto.md) y las
> parejas líderes de cada épica en el
> [backlog ejecutable](../../../../07-planificacion-y-trabajo-equipo/04-backlog-ejecutable.md).
...
([02](../../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) Parte 3). Nada más.
...
> RF-IA-32 salen casi gratis ([02](../../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) Parte 1 §4).
...
> cuota, no registra. Todo eso es del gateway. langchain4j ([ADR-016](../../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md))
...
([10](../../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md) Bloque 2, última fila). Sin esto no hay defensa posible
...
> **M7 es un solo módulo en [02](../../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) y
> [10](../../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md); acá son dos paquetes.** No es una contradicción:
...
> datos ([02](../../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) Parte 1 §7).
...
falta. La cola va en **Postgres con `SKIP LOCKED`** (o Redis) — ver [06 "Con qué tecnología"](../../../01-operacion-e-ingenieria.md).
...
[18](../../../../contracts/91-contratos-inter-equipos-historicos.md).
...
> equipo ([10](../../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md) Parte 2 §1).
...
### Orden de la demo — las cuatro semanas de [10](../../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md) Parte 2 §4
...
> [10](../../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md) Bloque 3 es explícito: **el chat es Fase 2 y se
