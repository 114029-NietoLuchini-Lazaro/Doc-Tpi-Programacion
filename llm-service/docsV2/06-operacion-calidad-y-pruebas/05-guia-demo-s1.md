...
> **Nota de vigencia.** Esta guía conserva el recorrido histórico de Sprint 1. Para ejecutar hoy el
> Workbench con backend real y fronteras simuladas use el [laboratorio de integración local](../../02-arquitectura-y-plataforma/07-laboratorio-integracion-local.md).
...
1. Situarse en la raíz del módulo `llm-service`.
...
### Paso 2: Alta de Rúbrica y Publicación
...
| **CA4:** Guía de demo paso a paso | Este documento ([`05-guia-demo-s1.md`](05-guia-demo-s1.md)) | ✅ Documentado |
