...
Los detalles de operaciones, cuerpos y respuestas están en [OpenAPI v1](../contracts/historicos-y-contratos-v1/llm-service-v1.openapi.yaml); la integración asíncrona se encuentra en [AsyncAPI v1](../contracts/historicos-y-contratos-v1/llm-service-v1.asyncapi.yaml)
...
La planificación de desarrollo debe tomar como punto de partida [la guía de fuentes de verdad](01-fuentes-de-verdad-y-convenciones.md), [la matriz de trazabilidad](04-matriz-trazabilidad.md) y los contratos v1, no el código de ejemplo ni las rutas históricas.
