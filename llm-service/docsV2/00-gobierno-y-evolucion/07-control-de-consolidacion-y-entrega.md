...
|---|---|---|
| Misma información para audiencias distintas | Se conserva; se enlaza a la fuente canónica para evitar divergencia. | Diagramas de [17](../contracts/90-mapa-de-integracion-historico.md) y contratos de [`contracts/equipos/tema-05-desafios-practicos.md`](../contracts/equipos/tema-05-desafios-practicos.md) o [`contracts/equipos/tema-11-chat.md`](../contracts/equipos/tema-11-chat.md). |
