...
| 3 | Contratos canónicos V2 en `docsV2/contracts/` y ADRs | Aplicación ejecutable de esas fuentes a Tema 07. |
...
- [ADR-017](02-decisiones-y-pendientes.md#adr-017--rúbricas-editables-y-versionadas-por-curso): el docente puede editar criterios, anclas, prompts y pesos; las cinco dimensiones siguen siendo obligatorias y los pesos deben sumar 100 %.
- [ADR-018](02-decisiones-y-pendientes.md#adr-018--selección-de-modelo-por-curso-sujeta-a-doble-calibración): el docente puede elegir por curso entre modelos habilitados por ADMIN; cada candidato debe superar calibración base y del curso.
...
> [`contracts/equipos/tema-03-motor-de-desafios.md`](../contracts/equipos/tema-03-motor-de-desafios.md)
...
El contrato HTTP vigente está en [`contracts/llm-service.openapi.yaml`](../contracts/llm-service.openapi.yaml) y el contrato de eventos en [`contracts/llm-service.asyncapi.yaml`](../contracts/llm-service.asyncapi.yaml). V1 queda bajo `contracts/historicos-y-contratos-v1/`. La cobertura de requisitos vive en [04 — Matriz de trazabilidad](04-matriz-trazabilidad.md).
