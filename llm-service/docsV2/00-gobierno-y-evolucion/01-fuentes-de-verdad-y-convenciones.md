...
Los contratos vigentes están en [`contracts/llm-service-v1.openapi.yaml`](../contracts/historicos-y-contratos-v1/llm-service-v1.openapi.yaml)y [`contracts/llm-service-v1.asyncapi.yaml`](../contracts/historicos-y-contratos-v1/llm-service-v1.asyncapi.yaml). La cobertura de requisitos vive en [21](04-matriz-trazabilidad.md)
