...
| RF-IA-12 a 18/25 — evaluador, detalle y apelación | MVP | OpenAPI: evaluaciones, apelaciones y overrides | `practice-service` publica `ATTEMPT_CLOSED` (desde el 2026-09-13; antes `challenges-service`) | Cinco dimensiones, confianza, justificación, auditoría append-only y nunca XP. |
