...
class RubricPublicationServiceTest {
  ...
  @Test void publishesOnlyAfterTheMandatoryDimensionsAndWeightsAreValid() {
    ...
    var version = new ar.edu.utn.frc.tup.piv.llm.application.service.RubricDraftService.RubricVersion(versionId, courseId, 1, "Name", "DRAFT", 1L, null, java.util.List.of());
