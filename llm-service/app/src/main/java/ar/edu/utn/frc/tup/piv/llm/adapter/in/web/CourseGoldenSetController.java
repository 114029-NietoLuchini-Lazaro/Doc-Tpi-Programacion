...
public class CourseGoldenSetController {
  ...
  public ResponseEntity<ar.edu.utn.frc.tup.piv.llm.adapter.out.persistence.CourseGoldenSetRepository.GoldenSetCaseSummary> addCase(@PathVariable UUID courseId, @PathVariable UUID versionId, @RequestBody ar.edu.utn.frc.tup.piv.llm.adapter.out.persistence.CourseGoldenSetRepository.GoldenSetCaseInput input, @RequestHeader HttpHeaders headers) {
  ...
  public ar.edu.utn.frc.tup.piv.llm.adapter.out.persistence.CourseGoldenSetRepository.GoldenSetDetail get(
  ...
  public ar.edu.utn.frc.tup.piv.llm.adapter.out.persistence.CourseGoldenSetRepository.GoldenSetCaseSummary updateCase(
      @PathVariable UUID courseId, @PathVariable UUID versionId, @PathVariable UUID caseId,
      @RequestBody ar.edu.utn.frc.tup.piv.llm.adapter.out.persistence.CourseGoldenSetRepository.GoldenSetCaseInput input,
      @RequestHeader HttpHeaders headers) {
    var actor = authorization.require(headers); courseAuthorization.requireTeacher(courseId, actor, headers);
  ...
  public record GoldenSetPage(List<ar.edu.utn.frc.tup.piv.llm.adapter.out.persistence.CourseGoldenSetRepository.CourseGoldenSetView> items) {}
