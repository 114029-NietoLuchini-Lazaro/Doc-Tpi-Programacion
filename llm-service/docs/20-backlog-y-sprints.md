...
> **Rebase obligatorio antes de planificar.** Este backlog es una estimación anterior a los contratos v1. La selección de historias debe respetar [21](21-matriz-trazabilidad-llm.md): excluir Fase 2/Fase 3, usar Kafka para eventos y reemplazar el dispatcher `/ai/{funcion}` por recursos bajo `/api/llm/**`.
