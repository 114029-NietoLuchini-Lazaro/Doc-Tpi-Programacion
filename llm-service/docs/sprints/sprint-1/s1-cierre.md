...
> — ver [38](../../38-plan-de-5-sprints.md); este cierre es parte del Sprint 1 de ese plan, no una
> numeración aparte.
>
...
|---|---|
| Sprint / fase | Cierre S1 / F1 (parte del Sprint 1 de [38](../../38-plan-de-5-sprints.md)) |
...
| 10 | Reescribir T1 de h08 contra el contrato v2 (no v1) | [`ep-01/h05.md`](../../tareas/ep-01/h05.md) T1 (rework) | P1 | — (decidido: `v1` histórico, [checklist §2.5](../../entregas/checklist-cierre-s1.md)) | 2 | Cierre S1 | Pendiente — ya desbloqueada |
