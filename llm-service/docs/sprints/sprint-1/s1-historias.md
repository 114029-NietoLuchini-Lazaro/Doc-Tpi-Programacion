...
> Según lo normado en [38 · Parte 3](../../38-plan-de-5-sprints.md) y [`capacidad-sprints.md`](../capacidad-sprints.md),
...
| | | | | | | **Total Estimado** | **~473–498 h + 9 ítems a estimar/sin ficha** | |

> **Nota sobre la carga de P1:** Si se computan los paquetes teóricos completos originales de base, P1 suma 146 h. Si se computa el cierre técnico auditado de [`s1-cierre.md`](s1-cierre.md) (Eureka, CI, 401/404, ADR y .env), P1 requiere ~55 h. Sumarle a P1 su parte del Hilo F (P1+P2, nuevo) es lo que empuja a S1 por encima de su alcance original.
>
