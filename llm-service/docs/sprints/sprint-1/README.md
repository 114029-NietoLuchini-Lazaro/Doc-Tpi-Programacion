...
> Épica y fichas ya escritas — [`historias/ep-07/`](../../historias/ep-07/README.md). Paquete histórico de referencia: [`35` · S9](../../35-backlog-ejecutable.md) (~208 h) — la ficha real de cada historia suma 86 h, no 208; se usa la cifra real.
