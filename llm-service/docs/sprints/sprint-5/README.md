...
> Buffer Interceptor — declarado fuera del contrato ejecutable hasta que se fusione ([`38`](../../38-plan-de-5-sprints.md) · Parte 4). **Sin ficha todavía** — se redacta en la Planning de S5 antes de comprometer horas exactas; ~50 h es referencia gruesa, no estimación fina.
