...
>   y son transversales al horizonte vigente ([5 sprints](../../38-plan-de-5-sprints.md), no los 19
>   que se plantearon originalmente); no se estiman ni pertenecen a un sprint. El Sprint 0
...
>   [`s1-historias.md`](../sprint-1/s1-historias.md)); el Sprint 0 las refina y las sube.
>
...
| Registrada en | Ficha de Taiga de `LLM-S01-H06` + [`../../historias/ep-03/h02.md`](../../historias/ep-03/h02.md) (LLM-EP03-H02) |
...
| `LLM-EP01-H01` *(S01-H01)* · ADR de arquitectura | Tarea (EP-01) | [`historias/ep-01/h01.md`](../../historias/ep-01/h01.md) · [tareas](../../tareas/ep-01/h01.md) | |
| `LLM-EP01-H02` *(S01-H02)* · Entorno reproducible | Tarea (EP-01) | [`historias/ep-01/h02.md`](../../historias/ep-01/h02.md) · [tareas](../../tareas/ep-01/h02.md) | |
| `LLM-EP01-H03` *(S01-H03)* · Esqueleto transversal | Tarea (EP-01) | [`historias/ep-01/h03.md`](../../historias/ep-01/h03.md) · [tareas](../../tareas/ep-01/h03.md) | |
| `LLM-EP01-H04` *(S01-H04)* · Esquema versionado con auditoría | Tarea (EP-01) | [`historias/ep-01/h04.md`](../../historias/ep-01/h04.md) · [tareas](../../tareas/ep-01/h04.md) | |
| `LLM-EP03-H01` *(S01-H05)* · Alta de golden set y carga de entradas | **HU** (EP-03) | [`historias/ep-03/h01.md`](../../historias/ep-03/h01.md) · [tareas](../../tareas/ep-03/h01.md) | |
| `LLM-EP03-H02` *(S01-H06)* · Consulta que sobrevive al reinicio | **HU** (EP-03) · **canónica** | [`historias/ep-03/h02.md`](../../historias/ep-03/h02.md) · [tareas](../../tareas/ep-03/h02.md) | |
| `LLM-EP03-H03` *(S01-H07)* · Pantalla docente mínima | **HU** (EP-03) | [`historias/ep-03/h03.md`](../../historias/ep-03/h03.md) · [tareas](../../tareas/ep-03/h03.md) | |
| `LLM-EP01-H05` *(S01-H08)* · Contrato OpenAPI y mock | Tarea (EP-01) | [`historias/ep-01/h05.md`](../../historias/ep-01/h05.md) · [tareas](../../tareas/ep-01/h05.md) | |
| `LLM-EP01-H06` *(S01-H09)* · Suite de pruebas y guía de demo | Tarea (EP-01) | [`historias/ep-01/h06.md`](../../historias/ep-01/h06.md) · [tareas](../../tareas/ep-01/h06.md) | |
