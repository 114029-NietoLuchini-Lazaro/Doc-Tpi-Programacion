...
> **Referencia:** [`38`](../../38-plan-de-5-sprints.md) · Parte 3 · Sprint 2
> **Recalibrado el 2026-09-13 (noche):** además de cerrar EP-06, cierra lo que Sprint 1 arrancó de EP-07 (Hilo F) y de la extensión de EP-09 (Hilo G) — P1, P2, P3 y P5 tenían hueco de sobra en la versión anterior de este sprint (~70-90h de ~581,6h) para absorberlo sin forzar nada.
...
> Cierra lo que el Hilo F de Sprint 1 dejó pendiente. Épica y fichas: [`historias/ep-07/`](../../historias/ep-07/README.md). Paquete histórico de referencia: [`35` · S10](../../35-backlog-ejecutable.md) (~208 h) — la ficha real de cada historia suma 70 h.
...
> Cierra lo que el Hilo G de Sprint 1 dejó pendiente. **Sin ficha de historia individual todavía** — se redacta en la Planning de S2. Paquete histórico de referencia: [`35` · S16](../../35-backlog-ejecutable.md).
