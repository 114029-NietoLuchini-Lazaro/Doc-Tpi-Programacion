...
> [`docs/31-spike-decodificacion-imagenes-y-rag-multifuente.md`](../../31-spike-decodificacion-imagenes-y-rag-multifuente.md).
> Se portó a pedido explícito, adelantando el trabajo de S14–S16
> ([`35`](../../35-backlog-ejecutable.md)) — no existían `docs/historias/ep-09/` todavía; se
> crearon junto con este código (ver [`docs/historias/ep-09/`](../../historias/ep-09/README.md)).
...
1. **Decodificación de diagramas es heurística** (bounding boxes + texto vectorial de PDFBox),
   ...
   [`docs/31`](../../31-spike-decodificacion-imagenes-y-rag-multifuente.md). No presentarlo como
   "detección con IA".
