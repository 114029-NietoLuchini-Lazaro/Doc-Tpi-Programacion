...
> **Límite de alcance del MVP.** No se implementa streaming token a token en tutoría práctica: RF-IA-20 exige verificar y, si hace falta, regenerar antes de mostrar la respuesta. Los ejemplos SSE de este documento son una alternativa futura, no el contrato vigente.
