...
| **Redis**                    | Contenedor propio, con persistencia AOF | Cola con prioridades · contadores de cuota (RF-IA-22) · caché de retrieval | Una cola por tipo de job; contadores con TTL de 24 h. Si hay override por alumno (back office, [08 P-12](08-decisiones-y-pendientes.md)), la clave del contador se compone de función **y** alumno, no solo función | 📋     | [12 §3](12-almacenamiento-e-ingesta.md) · [06 Parte 1](06-operacion-e-ingenieria.md) |
...
| **Cuota por desafío** | Lógica propia sobre Redis                          | Límite pedagógico (RF-IA-22): ~10 consultas al tutor por ejercicio, más un override opcional por alumno y por día (cantidad de usos y tokens) que configuraría el back office | `service/gateway/quota/`; rechaza **antes** de gastar un token                                                                                                                               | 📋     | [19 §2](19-modernizacion-seguridad-y-ratelimit-llm.md) · [08 P-12](08-decisiones-y-pendientes.md)                                                                |
