...
> nuestra, sin integración: [`docs/entregas/recomendacion-correccion-respuestas-cortas.md`](../../entregas/recomendacion-correccion-respuestas-cortas.md).
...
Product Owner:
[P-01](../../08-decisiones-y-pendientes.md#-p-01--corrector-de-respuestas-abiertas-fuera-de-alcance)
(2026-09-06). Mientras esa decisión no se reabra, no hay contrato que escribir acá más allá de
esta nota. Ver [`pendientes.md`](pendientes.md) para lo que sigue abierto.
...
- **Corrección de opción múltiple, V/F, ordenar, emparejar, algoritmos con tests y respuesta corta
  ...
  ([`04-funciones-de-ia.md` §1c](../../04-funciones-de-ia.md#1c-en-la-corrección-tres-de-cada-cuatro-tipos-no-necesitan-llm)).
