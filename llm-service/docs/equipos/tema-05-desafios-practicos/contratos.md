...
> Reglas generales: [18 §0](../../18-contratos-inter-equipos.md#0-cómo-leemos-los-contratos).
...
### Diagrama de secuencia completo (también vive en [17 §3](../../17-mapa-de-integracion.md#3-camino-sincrónico-a--el-tutor))
...
### Diagrama de secuencia completo (también vive en [17 §5](../../17-mapa-de-integracion.md#5-camino-asincrónico--el-evaluador))
