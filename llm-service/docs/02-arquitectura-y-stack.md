...
> **Convención obligatoria.** La identidad externa del servicio es `llm-service` y todo controller atiende bajo `/api/llm/**`. Este documento conserva diagramas previos con `ms-evaluacion-llm`; para diseño nuevo mandan [00](00-fuentes-de-verdad-y-convenciones.md) y los contratos v1.
