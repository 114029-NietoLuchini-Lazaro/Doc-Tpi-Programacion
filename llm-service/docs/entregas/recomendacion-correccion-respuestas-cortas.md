...
> [`11-glosario-y-metadata.md`](../11-glosario-y-metadata.md#las-ocho-colisiones)).
...
- [`08-decisiones-y-pendientes.md` — P-01](../08-decisiones-y-pendientes.md#-p-01--corrector-de-respuestas-abiertas-fuera-de-alcance),
...
- [`04-funciones-de-ia.md` §4](../04-funciones-de-ia.md#4-validación-académica-fuera-del-evaluador):
  *"`llm-service` no expone un corrector de respuestas abiertas y el Golden Set no recibe
  soluciones esperadas."*
- [`05-seguridad.md`](../05-seguridad.md#para-qué-sirve-tener-el-chunk-a-mano) ya analizó el caso
...
[`09-preguntas-y-respuestas.md`](../09-preguntas-y-respuestas.md#q-23) y
[`04-funciones-de-ia.md` §2.3.1](../04-funciones-de-ia.md).
...
[`commons-text` (`org.apache.commons.text.similarity.LevenshteinDistance`)](../09-preguntas-y-respuestas.md#q-23) —
