...
> **Gobierno vigente.** Los modelos se asignan por función dentro de `llm-service`; la configuración se administra mediante `admin-service` y los contratos v1. Ningún proveedor, nombre de servicio o endpoint histórico de este análisis prevalece sobre [00](00-fuentes-de-verdad-y-convenciones.md).
