# Tareas SMART — EP-03 · Golden set y referencia humana

> Una ficha por historia, igual que [`../../historias/ep-03/`](../../historias/ep-03/README.md).
...
## Índice — S2 (vigentes, escritas a posteriori)
