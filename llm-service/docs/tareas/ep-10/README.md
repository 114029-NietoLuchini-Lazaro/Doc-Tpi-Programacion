...
> Formato del [template oficial de Tarea de la Wiki de Taiga](../../plantillas/tarea-taiga.md); método **SMART**
...
> - Plan de sprints: [`../../38-plan-de-5-sprints.md`](../../38-plan-de-5-sprints.md) y [`../../sprints/sprint-5/README.md`](../../sprints/sprint-5/README.md).
>
