...
| **S2** | EP-03 (LLM-EP03-H04, H05) · EP-02 (LLM-EP02-H02) | 3 — **golden set versionado + conexión de modelo real** ([verificación](../entregas/verificacion-v2-golden-set-calibracion.md)) | — |
| **S3** | EP-04 (LLM-EP04-H01) | 1 — calibración de curso (motor completado con T7) | — |
| S4–S19 | ver [catálogo](../epicas/README.md) y [plan de 5 sprints](../38-plan-de-5-sprints.md) | *(sprint a sprint)* | — |
