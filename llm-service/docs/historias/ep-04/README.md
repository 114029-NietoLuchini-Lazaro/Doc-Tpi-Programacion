...
|---|---|---|---|---|---|
| [LLM-S03-H01](s03-h01.md) | Correr y activar una calibración de curso con métrica PAR-14 | **HU** de valor | P4 | H10 (EP-02, ✅), H01/H02 (EP-03, S2) | 🟢 Completa — T7 (conectar el modelo) cerrada el 2026-09-13, ver [sprint de cierre](../../sprints/s1-cierre.md) |
