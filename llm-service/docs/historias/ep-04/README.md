...
|---|---|---|---|---|---|
| [LLM-EP04-H01](h01.md) | Correr y activar una calibración de curso con métrica PAR-14 *(ex-S03-H01)* | **HU** de valor | P4 | EP-02·H01 (✅), EP-03·H04/H05 (S2) | 🟢 Completa — T7 (conectar el modelo) cerrada el 2026-09-13, ver [sprint de cierre](../../sprints/s1-cierre.md) |
