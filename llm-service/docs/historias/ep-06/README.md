...
> Taiga](../../plantillas/historia-de-usuario-taiga.md). **Carpeta nueva.** EP-06 estaba en
> **🔴 no iniciado** hasta esta pasada — ver la auditoría completa en
> [`docs/estado-implementacion/ep-06/evaluacion-y-apelacion.md`](../../estado-implementacion/ep-06/evaluacion-y-apelacion.md):
...
| [LLM-EP06-H03](h03.md) | Que mi entrega se acepte igual si el evaluador está caído *(ex-S06-H03)* | **HU** de valor | H02 | ⚪ Borrador |
...
> No confundir esta carpeta con [`estado-implementacion/ep-06/`](../../estado-implementacion/ep-06/README.md):
