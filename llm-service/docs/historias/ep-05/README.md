...
> Taiga](../../plantillas/historia-de-usuario-taiga.md). **Carpeta nueva.** El código de EP-05
> se construyó el 2026-09-12/13 sin ficha de HU — ver
> [`docs/estado-implementacion/ep-05/README.md`](../../estado-implementacion/ep-05/README.md),
...
> [adenda SSE](../../contracts/llm-service-v1-tutor-sse-adenda.md). DoR/DoD:
