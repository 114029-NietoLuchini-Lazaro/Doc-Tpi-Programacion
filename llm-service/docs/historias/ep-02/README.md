...
> Taiga](../../plantillas/historia-de-usuario-taiga.md). **H01** (anteriormente H10) es un **habilitador
...
>
> **Por qué existe esta carpeta.** El catálogo original ([`35`](../../35-backlog-ejecutable.md))
...
> [`35` · «S1»](../../35-backlog-ejecutable.md). DoR/DoD, desde
> [23 · §9.2](../../23-plan-construccion-producto-llm.md). El desglose en **tareas
...
> [38 · Parte 1](../../38-plan-de-5-sprints.md). Entra en el **Sprint 2** del plan vigente de
