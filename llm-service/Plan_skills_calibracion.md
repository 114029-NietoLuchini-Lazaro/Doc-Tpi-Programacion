...
el mismo flujo de seguridad definido para archivos PDF del RAG en `docsV2`.
...
**Restricción de integración:** `docsV2/contracts/01-inventario-y-brechas.md`
...
**Hallazgo documental:** docsV2 distingue ambos conceptos. `RubricDimension` es
...
**Fuente:** `docsV2/03-capacidades-de-ia/golden-set-y-calibracion/02-especificacion-funcional.md`
...
**Impacto técnico:** esta es una evolución material de docsV2 y del modelo
