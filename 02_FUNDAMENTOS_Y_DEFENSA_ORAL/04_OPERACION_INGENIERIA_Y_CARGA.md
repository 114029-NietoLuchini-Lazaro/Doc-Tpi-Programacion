...
> **Bus acordado.** Kafka es el bus compartido para eventos de integración. La cola de workers de `llm-service` sigue siendo interna y no se confunde con el bus. Los schemas y tópicos vigentes están en [`contracts/llm-service-v1.asyncapi.yaml`](contracts/llm-service-v1.asyncapi.yaml).
